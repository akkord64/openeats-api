...
class Recipe(models.Model):
    ...
    Calories = models.IntegerField(_('Calories'), help_text="enter the per serving calories value", default=0)
    TotalFat = models.IntegerField(_('TotalFat'), help_text="enter the per serving total fat value", default=0)
    SatFat = models.IntegerField(_('SatFat'), help_text="enter the per serving saturated fat value", default=0)
    Cholesterol = models.IntegerField(_('Cholesterol'), help_text="enter the per serving cholesterol value", default=0)
    Sodium = models.IntegerField(_('Sodium'), help_text="enter the per serving sodium value", default=0)
    TotalCarb = models.IntegerField(_('TotalCarb'), help_text="enter the per serving total carbohydrate value", default=0)
    Fibers = models.IntegerField(_('Fibers'), help_text="enter the per serving fiber value", default=0)
    Sugars = models.IntegerField(_('Sugars'), help_text="enter the per serving sugar value", default=0)
    Proteins = models.IntegerField(_('Proteins'), help_text="enter the per serving protein value", default=0)
